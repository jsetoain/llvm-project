...
llvm.func @vector_insert_extract(%f256: vector<8xi32>, %f128: vector<4xi32>,
                                 %sv: vector<[4]xi32>) {
  // CHECK: call <vscale x 4 x i32> @llvm.experimental.vector.insert.nxv4i32.v8i32
  %0 = llvm.intr.experimental.vector.insert %f256, %sv[0] :
              vector<8xi32> into vector<[4]xi32>
  // CHECK: call <vscale x 4 x i32> @llvm.experimental.vector.insert.nxv4i32.v4i32
  %1 = llvm.intr.experimental.vector.insert %f128, %sv[0] :
              vector<4xi32> into vector<[4]xi32>
  // CHECK: call <vscale x 4 x i32> @llvm.experimental.vector.insert.nxv4i32.v4i32
  %2 = llvm.intr.experimental.vector.insert %f128, %1[4] :
              vector<4xi32> into vector<[4]xi32>
  // CHECK: call <8 x i32> @llvm.experimental.vector.insert.v8i32.v4i32
  %3 = llvm.intr.experimental.vector.insert %f128, %f256[4] :
              vector<4xi32> into vector<8xi32>
  // CHECK: call <8 x i32> @llvm.experimental.vector.extract.v8i32.nxv4i32
  %4 = llvm.intr.experimental.vector.extract %2[0] :
              vector<8xi32> from vector<[4]xi32>
  // CHECK: call <4 x i32> @llvm.experimental.vector.extract.v4i32.nxv4i32
  %5 = llvm.intr.experimental.vector.extract %2[0] :
              vector<4xi32> from vector<[4]xi32>
  // CHECK: call <2 x i32> @llvm.experimental.vector.extract.v2i32.v8i32
  %6 = llvm.intr.experimental.vector.extract %f256[6] :
...
// CHECK-DAG: declare <vscale x 4 x i32> @llvm.experimental.vector.insert.nxv4i32.v8i32(<vscale x 4 x i32>, <8 x i32>, i64 immarg) #2
// CHECK-DAG: declare <vscale x 4 x i32> @llvm.experimental.vector.insert.nxv4i32.v4i32(<vscale x 4 x i32>, <4 x i32>, i64 immarg) #2
// CHECK-DAG: declare <8 x i32> @llvm.experimental.vector.insert.v8i32.v4i32(<8 x i32>, <4 x i32>, i64 immarg) #2
// CHECK-DAG: declare <8 x i32> @llvm.experimental.vector.extract.v8i32.nxv4i32(<vscale x 4 x i32>, i64 immarg) #2
// CHECK-DAG: declare <4 x i32> @llvm.experimental.vector.extract.v4i32.nxv4i32(<vscale x 4 x i32>, i64 immarg) #2
// CHECK-DAG: declare <2 x i32> @llvm.experimental.vector.extract.v2i32.v8i32(<8 x i32>, i64 immarg) #2
