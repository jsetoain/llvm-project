...
// CHECK: %[[T4:.*]] = vector.extract %[[T3]][%[[C0]]] : vector<2x2xf32>
// CHECK: %[[T5:.*]] = vector.extract %[[T1]][%[[C0]]] : vector<2xf32>
// CHECK: %[[T6:.*]] = vector.outerproduct %[[T4]], %[[T5]], %[[T2]] {kind = #vector.kind<add>} : vector<2xf32>, f32
// CHECK: %[[T7:.*]] = vector.extract %[[T3]][%[[C1]]] : vector<2x2xf32>
// CHECK: %[[T8:.*]] = vector.extract %[[T1]][%[[C1]]] : vector<2xf32>
...
// CHECK: %[[T1:.*]] = memref.load %[[B]][] : memref<vector<2xf32>>
// CHECK: %[[T2:.*]] = memref.load %[[C]][] : memref<vector<2xf32>>
// CHECK: %[[T3:.*]] = vector.extract %[[T0]][%[[C0]]] : vector<2x2xf32>
// CHECK: %[[T4:.*]] = vector.extract %[[T1]][%[[C0]]] : vector<2xf32>
// CHECK: %[[T5:.*]] = vector.outerproduct %[[T3]], %[[T4]], %[[T2]] {kind = #vector.kind<add>} : vector<2xf32>, f32
// CHECK: %[[T6:.*]] = vector.extract %[[T0]][%[[C1]]] : vector<2x2xf32>
// CHECK: %[[T7:.*]] = vector.extract %[[T1]][%[[C1]]] : vector<2xf32>
